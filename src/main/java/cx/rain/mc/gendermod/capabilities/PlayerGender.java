...
public class PlayerGender implements IPlayerGender {
    ...
    public static final String TAG_HAS_USE_POTION = "usedPotion";
    ...
    protected boolean hasUsePotion = false;
    ...
    @Override
    public boolean hasUsePotion() {
        return hasUsePotion;
    }

    @Override
    public void setUsedPotion(boolean value) {
        this.hasUsePotion = value;
    }
    ...
    public CompoundTag serializeNBT() {
        ...
        tag.putBoolean(TAG_HAS_USE_POTION, hasUsePotion);
    ...
    public void deserializeNBT(CompoundTag tag) {
        ...
        hasUsePotion = tag.getBoolean(TAG_HAS_USE_POTION);
    }
}
